...
- 全局 env 存储：`pkg/agentcompose/service/config_store.go`
- session 创建和 env 合并：`pkg/agentcompose/service/session_rpc_bridge.go`、`pkg/agentcompose/service/loader_manager.go`、`pkg/agentcompose/service/run_preparation.go`
...
- LLM service：`pkg/agentcompose/service/llm_client.go`、`pkg/agentcompose/service/service.go`
- Runtime LLM Facade：`pkg/agentcompose/service/llm_config.go`、`pkg/agentcompose/service/llm_runtime_config.go`、`pkg/agentcompose/service/llm_facade.go`
