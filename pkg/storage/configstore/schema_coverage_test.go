...
func assertProjectSchema(t *testing.T, store *ConfigStore) {
	...
	for table, columns := range map[string][]string{
		...
		"project_run": {"run_id", "parent_run_id", "root_run_id", "delegation_id", "delegation_attempt", "delegation_reason", "project_id", "project_name", "project_revision", "agent_name", "managed_agent_id", "source", "scheduler_id", "trigger_id", "status",
			"sandbox_id", "exit_code", "error", "prompt", "output", "result_json", "structured_result_json", "logs_path", "artifacts_dir", "cleanup_error", "driver", "image_ref", "started_at",
	...
	for _, index := range []string{
		...
		"idx_project_run_parent",
		"idx_project_run_root",
		"idx_project_run_delegation",
