...
func testDaemonListenConfigWorkflow(t *testing.T) {
	...
	t.Run("cli run trigger positional rejected", TestIntegrationCLIRunTriggerPositionalRejected)
	t.Run("cli run trigger positional json rejected", TestIntegrationCLIRunTriggerPositionalJSONRejected)
